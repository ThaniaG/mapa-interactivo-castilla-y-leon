    ...
    capaGeo = L.geoJson(DATOS_GEO, {
        ...
        style: feature => {
            ...
            if (estado.variable === 'kmeans') {
                ...
                const paleta = ['#e31a1c','#1f77b4','#ff7f0e','#2ca02c','#9467bd','#8c564b','#e377c2','#17becf','#bcbd22','#7f7f7f'];
                return {
...
document.getElementById('sel-variable').addEventListener('change', e => {
    ...
    const _barraJ = document.getElementById('filter-bar-jenny'); if (_barraJ) _barraJ.style.display = esKmeans ? '' : 'none';
